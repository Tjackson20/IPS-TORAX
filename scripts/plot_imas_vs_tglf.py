...
plots_dir = Path("plots/imas_vs_tglf")
plots_dir.mkdir(parents=True, exist_ok=True)

diff_dir = Path("plots/imas_vs_tglf_difference")
diff_dir.mkdir(parents=True, exist_ok=True)

profiles = read_profiles()
equilibrium = read_equilibrium()
tglf_output = "torax_outputs/tglf_new/state_history_20260723_112537.nc"
torax_initial = read_torax_output(output_file=tglf_output, time_index=0)
torax_final = read_torax_output(output_file=tglf_output, time_index=-1)
...
def make_plot(x_imas, y_imas, x_torax, y_initial, y_final, title, ylabel, filename):
    ...
    plt.plot(x_torax, y_initial, "--", label="TGLF initial state")
    plt.plot(x_torax, y_final, label="TGLF final state")
...
make_plot(
    ...
    "Electron Temperature: IMAS Input vs TGLF Initial/Final",
...
make_difference_plot(
    ...
    rho_torax_profiles,
    torax_final["electron_temperature"],
    "Difference: TGLF Final - IMAS Electron Temperature",
...
make_plot(
    ...
    "Ion Temperature: IMAS Input vs TGLF Initial/Final",
    "Ion temperature (keV)",
    "ion_temperature.png",
)
...
make_difference_plot(
    ...
    rho_torax_profiles,
    torax_final["ion_temperature"],
    "Difference: TGLF Final - IMAS Ion Temperature",
...
make_plot(
    ...
    "Electron Density: IMAS Input vs TGLF Initial/Final",
...
make_plot(
    ...
    "Ion Density: IMAS Input vs TGLF Initial/Final",
    "Ion density (m^-3)",
    "ion_density.png",
)
...
make_difference_plot(
    ...
    rho_torax_profiles,
    torax_final["electron_density"],
    "Difference: TGLF Final - IMAS Electron Density",
...
make_plot(
    ...
    "Safety Factor q: IMAS Input vs TGLF Initial/Final",
    "q",
    "q_profile.png",
)
...
make_difference_plot(
    ...
    rho_torax_q,
    torax_final["q_profile"],
    "Difference: TGLF Final - IMAS q",
    "Difference in q",
    "difference_q_profile.png",
)

print("Plots created successfully in plots/imas_vs_tglf/")
print("Difference plots created successfully in plots/imas_vs_tglf_difference/")
